...
set(NPM_COMMAND_PREFIX)
if(WIN32 AND NOT MINGW)
    set(NPM_COMMAND_PREFIX cmd /C)
endif()
...
add_custom_target(web-ui ALL
        ...
        COMMAND ${NPM_COMMAND_PREFIX} "${NPM}" install ${NPM_INSTALL_FLAGS}
        COMMAND "${CMAKE_COMMAND}" -E env "SUNSHINE_BUILD_HOMEBREW=${NPM_BUILD_HOMEBREW}" "SUNSHINE_SOURCE_ASSETS_DIR=${NPM_SOURCE_ASSETS_DIR}" "SUNSHINE_ASSETS_DIR=${NPM_ASSETS_DIR}" ${NPM_COMMAND_PREFIX} "${NPM}" run build  # cmake-lint: disable=C0301
